...
export const HoverAddButton = ({
  ...
  return (
    <button
      onClick={handleClick}
      className="absolute z-10 flex items-center justify-center w-[16px] h-[16px] bg-white hover:bg-gray-50 text-black rounded-full shadow-md hover:shadow-lg border border-[#e1e1e1] transition-all duration-200 ease-in-out transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
